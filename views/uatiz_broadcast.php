				...
				<div class="emailsmswrapper">
					<form action="<?php print(admin_url('uatiz_broadcast/email_sms/sendEmailSms')) ?>" enctype='multipart/form-data' method="post">
						...
						<div class="check_div_uatiz">
							<input name="mail_or_sms" onchange="checkedValue();" value="uatiz" class="check_label radio" type="radio" checked style="display:inline-block"> <span class="mail-or-sms-choice"><?php echo _l('send_as_uatiz'); ?></span>
						</div>

						<div class="check_div_mail">
							<input name="mail_or_sms" onchange="checkedValue();" value="mail" class="check_label radio" type="radio" style="display:inline-block"> <span class="mail-or-sms-choice"><?php echo _l('send_as_email'); ?></span>
						</div>

						<div class="check_div_sms" id="sms">
							<input name="mail_or_sms" onchange="checkedValue();" value="sms" class="check_label radio" type="radio" style="display:inline-block"> <span class="mail-or-sms-choice"><?php echo _l('send_as_sms'); ?></span>
						</div>
						
						<div class="div_uatiz_template_subject" id="template_subject">
							<label for="api_key" class="control-label"> 
								<?php echo _l('template_subject'); ?>
							</label>
								<input type="text" id="subject" value="" name="template_subject" class="form-control" autofocus="1">
						</div>
						<br>
...
<script type="text/javascript">
	...
	function checkedValue(){
		var checkedValue = $('.check_label:checked').val();
